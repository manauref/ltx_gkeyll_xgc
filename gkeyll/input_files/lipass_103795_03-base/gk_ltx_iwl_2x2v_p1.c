...
create_ctx(void)
{
  ...
  double psi_axis  = 4.3835108700000000e-04; // psi at the magnetic axis.
  double psi_LCFS  = -5.5560311699999997e-03; // LCFS psi coordinate for 863 mg shot (LTX_103955_03.eqdsk).
