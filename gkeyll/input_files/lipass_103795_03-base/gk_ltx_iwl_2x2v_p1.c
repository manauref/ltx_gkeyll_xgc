...
get_ltx_lower_vessel_info(struct ltx_lower_vessel_info *vvi) {
  // Must go through (R(s=0),Z(s=0)) = (0.1407097369409848, 0.0).
  ...
  double R[] = {
    0.14070974, 0.14070796, 0.1407167 , 0.14067371, 0.1436331 , 0.14395052,
    0.14409046, 0.14436846, 0.14493428, 0.14583431, 0.14696371, 0.14816304,
    0.14930802, 0.15035809, 0.15139697, 0.15254175, 0.15387665, 0.15544965,
    0.1572739 , 0.1593556 , 0.16167266, 0.16413195, 0.1665985 , 0.16900053,
    0.17138871, 0.17391306, 0.17671372, 0.17986679, 0.18336331, 0.18718604,
    0.19128322, 0.1955356 , 0.19983406, 0.20425527, 0.20907058, 0.21448734,
    0.22046275, 0.22683877, 0.23355989, 0.2407117 , 0.24834979, 0.25641893,
    0.26481525, 0.27347983, 0.28239359, 0.29152308, 0.30079936, 0.31015689,
    0.31956381, 0.32900756, 0.33847186, 0.34792902, 0.35735908, 0.36675569,
    0.37611271, 0.38540764, 0.39460603, 0.40367999, 0.41263049, 0.4214733 ,
    0.43021007, 0.43880718, 0.44721712, 0.45540926, 0.46339109, 0.47118607,
    0.47881742, 0.48630173, 0.49365616, 0.50089197, 0.50800664, 0.51497919,
    0.52178714, 0.52842294, 0.53489551, 0.54122202, 0.54741912, 0.55351015,
    0.5595225 , 0.56548984, 0.57142637, 0.57731701, 0.58312998, 0.58882895,
    0.59438813, 0.59981796, 0.60513903, 0.61037777, 0.61554683, 0.62062467,
    0.6255698 , 0.63034237, 0.63491186, 0.63926345, 0.64340267, 0.64733556,
    0.65106309, 0.65457049, 0.6578261 , 0.660798  
  };
  double Z[] = {
     0.        , -0.00946554, -0.01892939, -0.02840152, -0.03739822, -0.046836  ,
    -0.05630162, -0.06576345, -0.07521136, -0.0846338 , -0.09403141, -0.10342039,
    -0.1128161 , -0.12222294, -0.13163102, -0.14102677, -0.1503974 , -0.15973097,
    -0.16901877, -0.17825222, -0.18742945, -0.19656964, -0.20570787, -0.21486326,
    -0.22402227, -0.23314468, -0.24218603, -0.25111062, -0.25990633, -0.26856518,
    -0.27709773, -0.28555397, -0.29398695, -0.30235612, -0.31050522, -0.31826579,
    -0.32560694, -0.33260205, -0.33926703, -0.34546661, -0.35105635, -0.35600348,
    -0.36037273, -0.36418231, -0.36736527, -0.36986306, -0.37174466, -0.37316799,
    -0.37421746, -0.37485199, -0.37497905, -0.37459275, -0.37377681, -0.37263938,
    -0.37121179, -0.36942494, -0.3671936 , -0.36450084, -0.361422  , -0.35804635,
    -0.354405  , -0.35044529, -0.34610223, -0.34136109, -0.33627384, -0.3309046 ,
    -0.32530525, -0.31951079, -0.31355235, -0.30745037, -0.30120761, -0.2948065 ,
    -0.28823063, -0.28148106, -0.2745748 , -0.26753448, -0.26038   , -0.25313497,
    -0.24582454, -0.2384773 , -0.23110515, -0.22369628, -0.21622632, -0.20866904,
    -0.20100834, -0.19325543, -0.18542745, -0.17754414, -0.16961497, -0.16162707,
    -0.15355636, -0.14538242, -0.13709326, -0.12868767, -0.12017547, -0.11156601,
    -0.10286565, -0.09407425, -0.08518654, -0.0762    
  };
  vvi->num_points = npts;
...
create_ctx(void)
{
  ...
  char geqdsk_file[128] = "../../../experiment/li_passivated_103795_03/LTX_103795_03.eqdsk";
  ...
  double B0  = 0.5*(1.566393e-01+6.265720e-01);
  double mi  = mp;   // Hydrogen ions.
  double Te_max = 220*eV;
  double Ti_max = Te_max/2.0;
  double n_max  = 2.6e19;   // [1/m^3]
